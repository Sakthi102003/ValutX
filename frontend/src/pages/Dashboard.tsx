        ...
        <div className="flex h-screen bg-background overflow-hidden font-sans relative selection:bg-primary/30 selection:text-primary">
            ...
            <aside className={cn(
                ...
                <nav className="flex-1 space-y-2 overflow-y-auto scrollbar-hide">
                    ...
                    <SidebarItem icon={<Shield className="w-4 h-4" />} label="Identity Records" active={view === 'items' && activeTab === 'id'} onClick={() => { setView('items'); setActiveTab('id'); }} count={decryptedItems.filter(i => i.type === 'id').length} />
